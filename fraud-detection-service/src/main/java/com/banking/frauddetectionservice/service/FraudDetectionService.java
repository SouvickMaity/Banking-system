...
public class FraudDetectionService {
    ...
    public void checkTransaction(Map<String, Object> payload) {
      ...
      log.info("Checking transaction:{} account:{} balance:{} ",
              transactionId,accountNumber,amount);

       FraudCheckResult result = preformFraudChecks(accountNumber,amount,senderBalance);
    ...
    private FraudCheckResult preformFraudChecks(
        ...
        if(isVelocityExceeded(accountNumber)){
            return new FraudCheckResult(true,"Too many transaction in 60 second");
        }
